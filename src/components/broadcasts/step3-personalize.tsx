...
export function Step3Personalize({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-wa-text">Personalize Message</h2>
        ...
        <div className="space-y-4">
          {placeholders.map((placeholder) => {
            ...
            return (
              <div
                key={placeholder}
                className="rounded-xl border border-wa-border bg-wa-panel/50 p-4"
              >
                <div className="mb-3 flex items-center gap-2">
                  <span className="inline-flex items-center rounded-md bg-wa-green/10 px-2 py-0.5 text-xs font-mono font-medium text-wa-green">
                    {placeholder}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <div>
                    <label className="mb-1.5 block text-xs font-medium text-wa-muted">
                      Mapping Type
                    </label>
                    <Select
                      value={mapping.type}
                    ...
                    >
                      <SelectTrigger className="w-full border-wa-border bg-wa-surface text-wa-text">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent className="border-wa-border bg-wa-surface">
      ...
      <div className="rounded-xl border border-wa-border bg-wa-panel/50 p-4">
        <div className="mb-3 flex items-center gap-2">
          <Eye className="h-4 w-4 text-wa-green" />
          <p className="text-sm font-medium text-wa-text">Live Preview</p>
          <span className="text-xs text-wa-muted/80">({previewLabel})</span>
          {loadingPreview && (
            <Loader2 className="h-3.5 w-3.5 animate-spin text-wa-green" />
          )}
        </div>
        <div className="rounded-lg wa-preview-chat p-3">
          <div className="ml-auto max-w-[85%] rounded-lg bg-wa-teal/30 px-3 py-2 shadow-sm">
