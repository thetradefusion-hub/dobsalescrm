    ...
    <Card className="bg-wa-panel/40 border-wa-border">
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-wa-text">
          <KeyRound className="size-4 text-wa-green" />
          Password
        </CardTitle>
      ...
      <CardContent>
        <form onSubmit={onSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="current-password" className="text-wa-text">
              Current password
            </Label>
            <Input
              id="current-password"
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              <Label htmlFor="new-password" className="text-wa-text">
                New password
              </Label>
              <Input
                id="new-password"
            ...
            <div className="space-y-2">
              <Label htmlFor="confirm-password" className="text-wa-text">
