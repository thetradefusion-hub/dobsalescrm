...
export default function NewBroadcastPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-wa-text">New Broadcast</h1>
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`flex h-8 w-8 items-center justify-center rounded-full text-xs font-medium transition-all ${
                    isCompleted
                      ...
                      : isActive
                        ? 'border-2 border-wa-green bg-wa-green/10 text-wa-green'
                        : 'border border-wa-border bg-wa-surface text-wa-muted/80'
                  }`}
                >
                ...
                <span
                  className={`hidden text-sm font-medium sm:block ${
                    isActive ? 'text-wa-text' : isCompleted ? 'text-wa-green' : 'text-wa-muted/80'
                  }`}
                >
                  {step.label}
                </span>
              ...
              {index < steps.length - 1 && (
                <div
                  className={`mx-3 h-px flex-1 ${
                    index < currentStep ? 'bg-wa-green' : 'bg-wa-surface'
                  }`}
                />
              )}
            </div>
