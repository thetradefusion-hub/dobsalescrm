...
const SPEC_DEFAULT_STAGES = [
  ...
  { name: "Negotiation", color: "#25D366", position: 3 }, // purple
...
export default function PipelinesPage() {
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="h-8 w-48 animate-pulse rounded bg-wa-surface" />
          <div className="h-9 w-28 animate-pulse rounded-lg bg-wa-surface" />
        </div>
        <div className="flex gap-3">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="h-96 w-72 animate-pulse rounded-xl bg-wa-surface/50" />
          ))}
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align="start"
              className="w-64 border-wa-border bg-wa-panel text-wa-text"
            >
              {pipelines.length === 0 && (
                <DropdownMenuItem disabled className="text-wa-muted/80">
                  No pipelines yet
                </DropdownMenuItem>
              )}
              {pipelines.map((p) => (
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className="border-wa-border bg-wa-panel text-wa-text hover:bg-wa-surface"
          >
      ...
      {/* Board */}
      {pipelines.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-wa-border py-20">
          <GitBranch className="h-12 w-12 text-wa-muted" />
          <h3 className="mt-4 text-lg font-medium text-wa-text">
            No pipelines yet
          </h3>
      ...
      <Dialog open={newPipelineOpen} onOpenChange={setNewPipelineOpen}>
        <DialogContent className="sm:max-w-sm bg-wa-panel border-wa-border">
          <DialogHeader>
            <DialogTitle className="text-wa-text">New Pipeline</DialogTitle>
          </DialogHeader>
          <div className="py-2">
            ...
            <Input
              ...
              className="mt-2 bg-wa-surface border-wa-border text-wa-text"
              onKeyDown={(e) => {
